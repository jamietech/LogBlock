...
public class ExplosionLogging extends LoggingListener
{
	...
	public void onEntityExplode(EntityExplodeEvent event) {
		final WorldConfig wcfg = Config.getWorldConfig(event.getLocation().getWorld());
		if (wcfg != null) {
			...
			if (source == null) {
				...
				final Fireball fireball = (Fireball) source;
				final Entity shooter = fireball.getShooter();
				if (shooter == null) {
					return;
				}
